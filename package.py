...
# ============ 2. 项目打包 (7z) ============
print("=" * 50)
print("2. 打包完整项目 (TokenScope_v1.9.0.7z)")
project_7z = OUT / "TokenScope_v1.9.0.7z"
...
# ============ 3. 服务端 PHP 打包 ============
print("=" * 50)
print("3. 打包服务端 (server_php_v1.9.0.7z)")
php_7z = OUT / "server_php_v1.9.0.7z"
...
print(f"  项目:  TokenScope_v1.9.0.7z")
print(f"  服务端: server_php_v1.9.0.7z")
